#!/usr/bin/python3
"""
this module is composed by a function that multiplies two matrices
"""
...
def matrix_mul(m_a, m_b):
    ...
    Raises:
        ...
        TypeError: if the lists of m_a or m_b have no integers or float types
        TypeError: if the rows of m_a or m_b dont have the same size
        ValueError: if m_a or m_b cant be multiplied
    """
